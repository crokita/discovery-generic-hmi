...
perl -pi -e "s/ws:\/\/localhost:8087/$HMI_TO_BROKER_ADDR/g" /usr/app/generic_hmi/src/js/Controllers/Controller.js
...
perl -pi -e "s/WebSocket\(url\)/WebSocket\(url, \['echo-protocol'\]\)/g" /usr/app/generic_hmi/src/js/Controllers/Controller.js
cat /usr/app/generic_hmi/src/js/Controllers/Controller.js
